...
var and__18279__auto__ = garden.units.unit_QMARK_.call(null,x);
 ...
 */
garden.units.convert = (function garden$units$convert(p__20080,right){
var map__20083 = p__20080;
...
var m = cljs.core.get.call(null,map__20083__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.call(null,map__20083__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__20086 = temp__4425__auto__;
var _ = cljs.core.nth.call(null,vec__20086,(0),null);
var magnitude = cljs.core.nth.call(null,vec__20086,(1),null);
var unit = cljs.core.nth.call(null,vec__20086,(2),null);
...
var m1 = cljs.core.get.call(null,map__20099__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__20100 = u.call(null,y);
...
var m2 = cljs.core.get.call(null,map__20100__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__20104__i = 0, G__20104__a = new Array(arguments.length -  2);
while (G__20104__i < G__20104__a.length) {G__20104__a[G__20104__i] = arguments[G__20104__i + 2]; ++G__20104__i;}
  more = new cljs.core.IndexedSeq(G__20104__a,0);
} 
...
G__20106 = new cljs.core.IndexedSeq(G__20107__a,0);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__20106);
}
...
var map__20120__$1 = ((((!((map__20120 == null)))?((((map__20120.cljs$lang$protocol_mask$partition0$ & (64))) || (map__20120.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20120):map__20120);
...
var map__20121__$1 = ((((!((map__20121 == null)))?((((map__20121.cljs$lang$protocol_mask$partition0$ & (64))) || (map__20121.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20121):map__20121);
...
while (G__20125__i < G__20125__a.length) {G__20125__a[G__20125__i] = arguments[G__20125__i + 2]; ++G__20125__i;}
  more = new cljs.core.IndexedSeq(G__20125__a,0);
} 
...
G__20127 = new cljs.core.IndexedSeq(G__20128__a,0);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__20127);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.call(null,map__20141__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__20142 = u.call(null,y);
...
var m2 = cljs.core.get.call(null,map__20142__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u.call(null,(m1 * m2));
});
...
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__20148);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.call(null,map__20162__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__20163 = u.call(null,y);
var map__20163__$1 = ((((!((map__20163 == null)))?((((map__20163.cljs$lang$protocol_mask$partition0$ & (64))) || (map__20163.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20163):map__20163);
var m2 = cljs.core.get.call(null,map__20163__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u.call(null,(m1 / m2));
});
...
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__20169);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
